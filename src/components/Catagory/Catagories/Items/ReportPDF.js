...
function ReportPdf(clientes) {
  ...
  const dados = clientes.map((cliente,i) => {
    ...
    return [
      ...
      { text: cliente.itemName, fontSize: 9, margin: [0, 2, 0, 2] },
      { text: cliente.catId.catagoryName, fontSize: 9, margin: [0, 2, 0, 2] },
      ...
      table: {
        ...
        body: [
          [
            ...
            { text: "Item", style: "tableHeader", fontSize: 10, margin: [0, 1, 0, 1] },
